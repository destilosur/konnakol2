...
export class Compo {
  ...
  loadLocalStorage() {
    if (localStorage.getItem('compoNombre')) {
      this.nombre = localStorage.getItem('compoNombre') ? localStorage.getItem('compoNombre') : (this.nombre = '');
      this.grupo = localStorage.getItem('compoGrupo') ? localStorage.getItem('compoGrupo') : (this.grupo = '');
      this.nBeats = localStorage.getItem('compoNBeats') ? localStorage.getItem('compoNBeats') : (this.nBeats = '');
